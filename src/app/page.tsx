...
const Page = () => {
  ...
  const DisplayMidSection = () => {
    if (clicked === "Home") {
      return <DisplayQuotes user={users[0]}/>;
    } else if (clicked === "Bookmark") {
      return <Bookmarks />;
    } else if (clicked === "Messages") {
      return <Messages />;
    } else {
      return <Profile user={users[0]} />;
    }
  };
    ...
    <main className={styles.main}>
      ...
      <div className={styles.bottom}>
        <div className={styles.bottomBar}>
          ...
          >
            <Image src="/imgs/bookmark.png" width={30} height={30} alt="" />
          </div>

          <div className={styles.barItems} onClick={() => setClicked("Home")}>
            <Image src="/imgs/home.png" width={30} height={30} alt="" />
          </div>
          ...
          >
            <Image src="/imgs/chat.png" width={30} height={30} alt="" />
          </div>
          ...
          >
            <Image src="/imgs/user.png" width={30} height={30} alt="" />
          </div>
        </div>
      </div>
    </main>
